...
(function($) {
    ...
    $(document).ready( function() {
		...
		if ( pricingMonthlyBtn[0], pricingYearlyBtn[0] ) {
			pricingMonthlyBtn[0].addEventListener("click", function(){ 
				pricingYearly[0].classList.add("hide");
				pricingMonthly[0].classList.remove("hide");
			...
			pricingYearlyBtn[0].addEventListener("click", function(){ 
				pricingYearly[0].classList.remove("hide");
				pricingMonthly[0].classList.add("hide");
...
/*** Footer Google map */
const mapId = $("#map")[0];
const contactMapId = $("#contact-map")[0];
const servicesMapId = $("#services-map__map")[0];

const pinRed = document.querySelector(".pinRed");
const pinYellow = document.querySelector(".pinYellow");
